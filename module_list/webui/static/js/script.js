...
document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch('/api/modules')
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('total-config-count').textContent = 
                        state.modules.reduce((sum, module) => sum + module.item_count, 0);
    ...
    function renderConfigItem(config) {
        ...
        switch (configType) {
            ...
            case 'list':
            case 'array':
                const listValue = Array.isArray(currentValue) ? currentValue.join(', ') : JSON.stringify(currentValue);
                inputField = `
